export const lnList = {
    ...
    'ERRFILETYPE' : { 'EN' : 'IMAGE TYPE IS NOT ALLOWED', 'ES' : 'TIPO DE IMAGEN NO PERMITIDO'},
    'IMAGESIZE' : { 'EN' : 'IMAGE COULD NOT BE LOADED BECAUSE OF SIZE OVER 6MB' , 'ES' : 'IMAGEN NO PUDO SER CARGADA PORQUE SUPERA LOS 6MB'},
    'UPLIMAGECONFIRM' : { 'EN' : 'Are you sure to upload this image?' , 'ES' : '¿estás seguro de subir esta imagen?'}
}